...
import 'package:stulast/screens/add_new_screen.dart';
import 'package:stulast/screens/search.dart';
...
import '../database/db_model/newclass.dart';
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            ...
            //           List<StudenNewtModel> studentListView,
            //           Widget? child) {
                ...
                return Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final studentData = value.studentList[index];
                      return Card(
                        elevation: 5,
                        child: ListTile(
